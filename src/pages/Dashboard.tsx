...
import { Users, Car, Building2, AlertTriangle, Plus } from 'lucide-react';
...
function VendorNode({ vendor, onEdit, onAddChild }: VendorNodeProps) {
  return (
    <div className="relative p-4 bg-gray-100 rounded-lg shadow-md border border-gray-300 min-w-[200px]">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.name}
              className="relative overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:px-6 sm:py-6"
            >
              <dt>
